...
describe('Delete equipamentos', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('Delete equipamentos', async function() {
    ...
    await driver.findElement(By.css(".grid:nth-child(6) .svg-inline--fa:nth-child(2) > path")).click()
